...
the user request contains the search keyword(s) in Chinese or English.

## Steps

### 1. Navigate

Use `chrome-devtools.navigate_page` → `https://kns.cnki.net/kns8s/search`
...
```
Searched CNKI for "the user request": found {total} results (page {page}).
