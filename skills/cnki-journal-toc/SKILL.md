...
3. Use `chrome-devtools.list_pages` to find the new reader tab
4. Use `chrome-devtools.select_page` to switch to it
5. Use `chrome-devtools.wait_for` with text `["下载"]`
